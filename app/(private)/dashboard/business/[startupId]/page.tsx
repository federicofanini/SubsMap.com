...
import { Globe, Twitter, Github, ArrowLeftIcon } from 'lucide-react';
  ...
  return (
    <div className="max-w-4xl mx-auto bg-black text-white p-4 rounded-lg mt-4">
      <div className="flex items-center mb-4">
        ...
        <h1 className="text-2xl font-bold">{startup.name} Details</h1>
      </div>
      <Separator className="my-4" />
      
      <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
        <Card className="bg-black text-white p-4 rounded-lg border-none">
          <CardHeader>
